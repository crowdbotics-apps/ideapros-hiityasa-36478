...
## Project Structure
    ...
    ├── ideapros_hiityasa_36478  # Django project configurations
...
1. Clone this repo and `cd ideapros_hiityasa_36478`
...
2. Clone this repo and `cd ideapros_hiityasa_36478`
